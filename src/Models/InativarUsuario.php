...
class InativarUsuario implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the InativarUsuario object to a human-readable string representation.
     *
     * @return string The string representation of the InativarUsuario object.
     */
