...
class CadastrarFilial implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the CadastrarFilial object to a human-readable string representation.
     *
     * @return string The string representation of the CadastrarFilial object.
     */
