...
class DeletarBrindes implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the DeletarBrindes object to a human-readable string representation.
     *
     * @return string The string representation of the DeletarBrindes object.
     */
