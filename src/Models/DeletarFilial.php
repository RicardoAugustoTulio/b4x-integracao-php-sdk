...
class DeletarFilial implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the DeletarFilial object to a human-readable string representation.
     *
     * @return string The string representation of the DeletarFilial object.
     */
