...
class DeletarProdutos implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the DeletarProdutos object to a human-readable string representation.
     *
     * @return string The string representation of the DeletarProdutos object.
     */
