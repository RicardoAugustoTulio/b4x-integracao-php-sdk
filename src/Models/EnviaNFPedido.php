...
class EnviaNFPedido implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the EnviaNFPedido object to a human-readable string representation.
     *
     * @return string The string representation of the EnviaNFPedido object.
     */
