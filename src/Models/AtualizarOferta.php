...
class AtualizarOferta implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the AtualizarOferta object to a human-readable string representation.
     *
     * @return string The string representation of the AtualizarOferta object.
     */
