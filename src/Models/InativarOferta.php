...
class InativarOferta implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the InativarOferta object to a human-readable string representation.
     *
     * @return string The string representation of the InativarOferta object.
     */
