...
class NewRequest implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the NewRequest object to a human-readable string representation.
     *
     * @return string The string representation of the NewRequest object.
     */
