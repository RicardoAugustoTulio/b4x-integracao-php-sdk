...
class DadosDoCliente implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the DadosDoCliente object to a human-readable string representation.
     *
     * @return string The string representation of the DadosDoCliente object.
     */
