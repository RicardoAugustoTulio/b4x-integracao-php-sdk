...
class AtualizarFilial implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the AtualizarFilial object to a human-readable string representation.
     *
     * @return string The string representation of the AtualizarFilial object.
     */
