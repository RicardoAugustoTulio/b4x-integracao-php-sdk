...
class DeletaNFPedido implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the DeletaNFPedido object to a human-readable string representation.
     *
     * @return string The string representation of the DeletaNFPedido object.
     */
