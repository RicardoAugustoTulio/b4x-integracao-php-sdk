...
class EnviaEventosDoPedido implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the EnviaEventosDoPedido object to a human-readable string representation.
     *
     * @return string The string representation of the EnviaEventosDoPedido object.
     */
