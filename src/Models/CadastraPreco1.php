...
class CadastraPreco1 implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the CadastraPreco1 object to a human-readable string representation.
     *
     * @return string The string representation of the CadastraPreco1 object.
     */
