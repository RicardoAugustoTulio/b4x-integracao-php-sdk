...
class CadastraOferta implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the CadastraOferta object to a human-readable string representation.
     *
     * @return string The string representation of the CadastraOferta object.
     */
